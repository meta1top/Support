...
export const ErrorCode = defineErrorCode({
  ...
  I18N_CONTEXT_NOT_FOUND: {
    code: 500,
    message: "I18nContext not found. Make sure I18nModule is properly configured.",
  },

  // 配置相关错误 (300-399)
  CONFIG_NOT_FOUND: { code: 3000, message: "Config not found" },
  CONFIG_INVALID: { code: 3001, message: "Config is invalid" },
});
